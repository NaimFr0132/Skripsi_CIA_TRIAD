      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="border p-3">Aktivitas</th>

            <th className="border p-3">IP</th>
        ...
        <tbody>
          {logs.map((log) => (
            <tr key={log.id}>
              <td className="border p-3">{log.username}</td>

              <td className="border p-3">{log.activity}</td>
              ...
              <td>
                {log.image_path ? (
                  <a
                    href={`http://127.0.0.1:8000/${log.image_path}`}
                    target="_blank"
                    rel="noreferrer"
